...
var ERR_OPEN_CONFIG = "Erreur dans l'ouverture du fichier de configuration. S'il n'existe pas, veuillez utiliser la commande init pour le créer.\nSinon, assurez vous de lancer la commande dans un répertoire contenant un fichier de configuration valide."
...
var ERR_CURRENT_DIR_OPEN = "Erreur : l'ouverture du dossier racine du projet semble impossible"
